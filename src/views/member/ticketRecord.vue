...
import * as $ticketRecord from "@/api/member/ticketRecord";
...
const pageData: any = reactive({
  ...
  tableParams: {
    columns: [
      ...
      { label: "USDT", prop: "amount", slot: "amountScope" },
      { label: "gas数量", prop: "gas", slot: "gasScope" },
      {
        label: "购买时间",
        prop: "blockTime",
        slot: "blockTimeScope"
