...
//请求相关
import * as $nodeApi from "@/api/member/node";
...
const pageData: any = reactive({
  ...
  tableParams: {
    columns: [
      ...
      { label: "节点单号", prop: "payNo", width: "150px" },
      {
        label: "购买代币",
        prop: "payErc20",
        slot: "addressScope",
      ...
      { label: "节点价值", prop: "value", slot: "amountScope", width: "140px" },
      {
        label: "已铸造的UT",
        prop: "claimUt",
        slot: "amountScope",
      ...
      { label: "区块号", prop: "blockNum", width: "140px" },
      { label: "购买时间", prop: "blockTime", width: "180px" }
    ],
    list: [],
    loading: false,
    pagination: {
  ...
  <el-card :shadow="'never'">
    ...
    >
      ...
      <template #statusScope="scope">
        <span>
          {{ scope.row[scope.column.property] === 1 ? "已结束" : "进行中" }}
        </span>
      </template>
    </pure-table>
  </el-card>
